  ...
  BigBangABI: [
    {
      inputs: [
        {
          internalType: 'contract SingleToken',
          name: '_single',
          type: 'address',
        },
        {
